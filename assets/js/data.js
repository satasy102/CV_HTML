...
let interest_football = new Interest(1, "Football", "assets/images/football.png", 1);
let interest_lol = new Interest(2, "League Of Legends", "assets/images/lol.png", 1);
let interest_pes = new Interest(3, "PES", "assets/images/pes.png", 1);
...
let knowleage_1 = "Xây dựng được bố cục trang web, có phát triển thêm phần chạy ảnh trong tin mới. Có reponsive. Sử dụng Javascript để thiết lập chức năng tìm kiếm bài viết (Có chuẩn hóa chuỗi)";
let project_1 = new Project(1, "Mô phỏng trang chủ Liên Minh 360", "7 ngày", "1 người", "JavaScript ES6", "Không dùng", "HTML5/CSS3/Javascript ES6", "Không dùng", knowleage_1, "assets/images/project1.PNG", "Không có", "http://bit.ly/39OGbFY", "Không có", "http://bit.ly/36g1XkM", 1);

let knowleage_2 = "Validate thông tin (front-end, back-end), phân tích thiết kế database, CRUD 4 bảng quan hệ với nhau, đăng nhập vào trang admin, xét duyệt hồ sơ, sử dụng thư viện summernote để thêm sửa bài viết, phân trang bằng backend";
let project_2 = new Project(2, "Trang web quản lý thông tin đăng ký thi Hoa hậu Việt Nam", "10 ngày", "1 người", "Java, Javascript ES6", "Servlet", "JSP/JSTL, HTML5/CSS3, Bootstrap 4, template AdminLTE", "PostgreSQL", knowleage_2, "assets/images/project2.PNG", "admin; Password@123", "http://bit.ly/3t0H6vO", "http://bit.ly/3a4rsXv", "http://bit.ly/3cdCYCt", 1);

let knowleage_3 = "Xây dựng bố cục kỹ thuật dự án theo mô hình MVC, phân tích thiết kế database, thiết kế giao diện bán hàng, dùng Github để quản lý mã nguồn khi làm việc nhóm, CRUD 8/17 bảng với quan hệ với nhau, validate thông tin nhập vào (front-end, back-end), xử lý đồng bộ và bất đồng bộ trong ajax, upload file ảnh, đăng nhập phân quyền bằng Spring Security.";
let project_3 = new Project(4, "Trang web hỗ trợ quản lý bán hàng", "25 ngày", "2 người", "Java, Javascript ES6", "Spring Boot, Spring Security, Ajax, jQuery, Thymeleaf, JPA, Restful API", "Bootstrap 4, CSS3, HTML5, template Admin: Gentelella-master, template Login: Login_v16", "PostgreSQL", knowleage_3, "assets/images/project4.PNG", " admin@gmail.com; Password@123", "https://bit.ly/3ogD1jm", "http://bit.ly/36gnLNa", "http://bit.ly/2KR4Eln", 1);
...
let referencePerson_1 = new ReferencePerson(1, "Mr.Lê Tường Phúc", "Giám đốc điều hành trung tâm CodeGym Huế", "Công ty CODEGYM VIETNAM JSC", "0983.339.720", "phuc.le@codegym.vn", 1);
referencePersons.push(referencePerson_1);
